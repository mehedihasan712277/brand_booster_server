...
export const registerUserSchema = z.object({
    body: z
        .object({
            ...
            email: z.string().refine((value) => /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(value), { message: "Invalid email address" }),
            password: z
                .string()
            ...
            role: z
                ...
                .refine((value) => ["admin", "user", "moderator"].includes(value), { message: "Invalid role type" }),
        })
        .refine((data) => !!data.role, { message: "Role is required", path: ["role"] }),
});
